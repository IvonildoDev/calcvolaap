...
import RegisterWellScreen from './screens/RegisterWellScreen';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
      ...
      <NavigationContainer>
          ...
          screenOptions={({ route }) => ({
            ...
            tabBarIcon: ({ color, size }) => {
              ...
              if (route.name === 'Calculator') {
                ...
                iconName = 'pipe';
              } else if (route.name === 'RegisterWell') {
        ...
        >
          ...
          <Tab.Screen name="RegisterWell" component={RegisterWellScreen} options={{ title: 'Cadastrar Poço' }} />
